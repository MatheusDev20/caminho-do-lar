...
export const HighlightSection = ({
  ...
  return (
    <section
      className="
        flex mx-auto w-full rounded-xl overflow-hidden max-w-[1470px] relative items-center justify-center
    ...
    >
      ...
      <button
        ...
        className="text-white bg-primary-700 hover:bg-primary-800 transition ease-in-out max-w-[50%] mb-6 self-center delay-75 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none border-none p-4 absolute bottom-0"
      >
