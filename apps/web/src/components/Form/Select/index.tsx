...
export const Select = ({ options, placeholder, label }: Props): JSX.Element => {
        ...
        <div className="w-full px-4">
          <div className="flex flex-col items-center relative">
            <div className="w-full">
              ...
              <div className="my-2 p-1 bg-white flex border border-gray-200 rounded">
                ...
                <div
                  ...
                  className="text-gray-300 w-8 py-1 pl-2 pr-1 border-l flex items-center border-gray-200 hover:bg-slate-50"
                >
            ...
            {options.length > 0 && openDropDown && (
              <div className="absolute shadow bg-white top-[100%] z-40 w-full lef-0 rounded max-h-[300px] overflow-y-auto">
                <div className="flex flex-col w-full">
                  {options.map((option, i) => (
                    <React.Fragment key={i}>
                      <div className="cursor-pointer w-full border-gray-100 hover:bg-teal-100">
